...
public class Messages {
    ...
    public static final String WARNING_NO_TASK = "This task index does not exist. Please try again.";
    public static final String WARNING_NO_BOOK = "This book index does not exist. Please try again.";
    public static final String WARNING_NO_LINK = "This link index does not exist. Please try again.";
    public static final String WARNING_NO_MODULE = "This module index does not exist. Please try again.";
